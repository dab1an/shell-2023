    ...
    <main className="">
      <div className="w-full flex items-center align-center flex-col pt-10 pb-10">
        <h1 className="text-6xl">
          {" "}
          <b> Don't settle for any credit card </b>{" "}
        </h1>
        <h1 className="text-5xl">
          {" "}
          <b> Find the right one! </b>
        </h1>
      </div>
      ...
      <div className="flex space-x-10 px-3 flex items-center align-center">
        <div className=" p-11 bg-blue-500 ">
          <h1 className="text-4xl mb-4">
            {" "}
            Unlock your financial potential as a student by taking our quick
            quiz and discover the perfect credit card tailored to your needs.
          </h1>
          ...
          <Link className="bg-red-500 " href="/quiz">
            {" "}
            <TheButton>go to Quiz</TheButton>{" "}
          </Link>
        </div>
